...
$sub_folder = 'ITC250-P3_FoodTruck/foodtruck/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'jennifer.villacis@seattlecentral.edu'); # Email of site support
...
$config->style = 'simplex.css'; #currently only Bootswatch Theme uses style to switch look & feel
